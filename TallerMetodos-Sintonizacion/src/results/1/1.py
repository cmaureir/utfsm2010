...
f1, f2, f3  = open("pb_200_01.res.1","r"),  open("pb_200_09.res.1","r"),  open("pb_200_10.res.1","r")
...
plot1 = p.plot(pop_1,fit_1,label='pb_200_01')
plot2 = p.plot(pop_1,fit_2,label='pb_200_09')
plot3 = p.plot(pop_1,fit_3,label='pb_200_10')

title('POP vs fitness')
legend((plot1,plot2,plot3),('pb_200_01','pb_200_09','pb_200_10'),loc='upper right')
grid(True)
p.axis([10,211,120,270],0.01)
xlabel('POP size')
ylabel('Fitness')
p.show()
