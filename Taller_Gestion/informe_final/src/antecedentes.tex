...
continuo desarrollo.
% CORRECCION 2
% Pide hacer un estudio del ultimo parrafo, de la experiencia 
%vivida, podriamos hacer un grafico de objetivos cumplidos 
%(proyectos, publicaciones, practicas) en funcion de tecnologias 
%utilizadas en el tiempo y de los contactos logrados a traves del 
%uso de dichas tecnologias
