...
\begin{titlepage}
	...
	%Titulo del Documento
	    \begin{tabular}{c}
		\vspace{1cm}
		\Huge{\sc{Síntesis}}\\\vspace{0.5cm}
		\LARGE{``Principios y Conceptos de la Gestión de Proyectos'' }\\\vspace{1cm}
		\LARGE{\sc{Taller de Gestión de Proyectos Informáticos}}
	    \end{tabular}
	...
	%Nombre del (o los) autor(es)
	   ...
	   \end{tabular}
       \vspace{1.2cm}\\
		\large{\sc{Profesor: José Contreras}}
	   \vspace{1.2cm}\\
	%Fecha
		\large{\sc{Valparaíso, Septiembre 2010.}}
    \end{center}
\end{titlepage}
